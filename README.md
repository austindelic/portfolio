...
[Open the website](https://austindelic.com) · [Terminal source](./apps/tui/) · [Shared shaders](./packages/black-hole/)
...
- [Black-hole package](./packages/black-hole/) · Shared shaders and camera routes. Shader attribution lives with the source.
